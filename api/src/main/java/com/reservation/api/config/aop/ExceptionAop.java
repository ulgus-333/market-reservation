...
import com.reservation.api.error.dto.ErrorLog;
import com.reservation.api.error.dto.ExceptionConverter;
...
public class ExceptionAop {
    ...
    @Pointcut("execution(* com.reservation.api.*.presentation..*.*(..))")
