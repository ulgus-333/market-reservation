...
import com.reservation.common.error.exception.ValidationException;
import com.reservation.common.error.type.ForbiddenType;
import com.reservation.common.error.type.InternalServerErrorType;
import com.reservation.common.error.type.MethodNotAllowedType;
...
public enum ExceptionConverter {
    NOT_HANDLED_COMMON_EXCEPTION(
            Exception.class,
            (exception) -> new FailureResponse(InternalServerErrorType.INTERNAL_SERVER_ERROR.getErrorTypeCode(), exception.getMessage()),
