...
import com.reservation.common.properties.AppProperties;
...
public class CryptoExecutor {
    ...
    @PostConstruct
    public void init() {
        KEY_SPEC = new SecretKeySpec(properties.getCryptoSecretKey().getBytes(StandardCharsets.UTF_8), "AES");
    }
    ...
    public static String encrypt(String plainText) {
        try {
            ...
            throw new BusinessException(InternalServerErrorType.FAILED_TO_ENCRYPT_VALUE);
        }
    }
    ...
    public static String decrypt(String encryptedIvText) {
        try {
            ...
            throw new BusinessException(InternalServerErrorType.FAILED_TO_DECRYPT_VALUE);
        }
    }
